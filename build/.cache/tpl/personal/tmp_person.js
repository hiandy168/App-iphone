/*TMODJS:{"version":2,"md5":"27cf73a591ab40597717d4d0ae04074a"}*/
template('tpl/personal/tmp_person',function($data,$filename
/**/) {
...
$out+=$escape(nickname);
$out+='" class="mui-input-clear"> </div> </div> </div> </div> </div>  <div id="xingbie" class="mui-page"> <div class="mui-navbar-inner mui-bar mui-bar-nav"> <button type="button" class="mui-left mui-action-back mui-btn mui-btn-link mui-btn-nav mui-pull-left"> <a class="mui-icon mui-icon-left-nav"></a> </button> <h1 class="mui-center mui-title">性别</h1> </div> <div class="mui-page-content"> <div class="mui-scroll-wrapper"> <div class="mui-scroll"> <ul id="data_sex" class="mui-table-view mui-table-view-radio"> <li class="mui-table-view-cell ';
if(sex==1){
$out+='mui-selected';
}
...
$out+='" data-sex="2"> <a class="mui-navigate-right">女</a> </li> </ul> </div> </div> </div> </div>  <div id="person_birthday" class="mui-page"> <div class="mui-navbar-inner mui-bar mui-bar-nav"> <button type="button" class="mui-left mui-action-back mui-btn mui-btn-link mui-btn-nav mui-pull-left"> <a class="mui-icon mui-icon-left-nav"></a> </button> <h1 class="mui-center mui-title">生日</h1> </div> <div class="mui-page-content"> <div class="mui-scroll-wrapper"> <div class="mui-scroll"> <button id=\'birth_date\' data-options=\'{"type":"date","beginYear":1970,"endYear":2016}\' class="btn mui-btn mui-btn-block margin_top_20">';
if(birthday==''||birthday==null||birthday==undefined){
$out+='选择日期';
}else{
$out+=$escape(birthday);
}
$out+='</button> </div> </div> </div> </div>  <div id="qinggan" class="mui-page"> <div class="mui-navbar-inner mui-bar mui-bar-nav"> <button type="button" class="mui-left mui-action-back mui-btn mui-btn-link mui-btn-nav mui-pull-left"> <a class="mui-icon mui-icon-left-nav"></a> </button> <h1 class="mui-center mui-title">情感状态</h1> </div> <div class="mui-page-content"> <div class="mui-scroll-wrapper"> <div class="mui-scroll"> <select name="basic" id="basic" class="margin_top_20"> <option value="保密" ';
if(basic=='保密'){
$out+='selected';
}
