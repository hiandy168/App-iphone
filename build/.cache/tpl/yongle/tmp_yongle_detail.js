/*TMODJS:{"version":1,"md5":"6d544dcb8cd5697dfce278eea89772a7"}*/
template('tpl/yongle/tmp_yongle_detail',function($data,$filename
/**/) {
...
$out+=' </div> </div> </li> </ul> <div class="mui-table-view margin_top_10"> <div class="mui-table-view-cell"> <span class="vertical_align_sub">购买数量</span> <div class="mui-numbox mui-pull-right" data-numbox-min="1"> <button class="mui-btn mui-btn-numbox-minus" type="button">-</button> <input id="number" class="mui-input-numbox" type="number" name="number"/> <button class="mui-btn mui-btn-numbox-plus" type="button">+</button> </div> </div> </div> <div class="color_ff781e" style="margin: 20px 5px;"> <p class="color_ff781e">温馨提示：</p> <p class="color_ff781e">1、说明：预订单并不代表您一定能购成功购得此票品，请您在订单生成24小时内保持手机畅通，票品的有无以最终电话确认为准，感谢！</p> <p class="color_ff781e">2、由于票务商品有有效时间及有限数量的特殊性质，一旦出票后，我们可能因客观原因，无法为您退、换票。（演出时间变更、内容变更除外）</p>  </div> <input type="hidden" name="id" value="';
