/*TMODJS:{"version":2,"md5":"64f4a59c00c88adec93485caf4851c6d"}*/
template('tpl/public/footer',function($data,$filename
/**/) {
...
$out+=' </div> <div class="popUp_close"> <img src="../images/icon/nav/popUp_close.svg"/> </div> </div> <script> /*初始化侧滑*/ mui(\'#offCanvasSideScroll\').scroll(); /*初始化5+插件*/ mui.plusReady(function () { mui(\'#logout\')[0].addEventListener(\'tap\',function(){ jQuery.ajaxJsonp(web_url +\'/mobile/userAuth.php\',{ \'act\': \'logout\', },function (result) { console.log(result); if (result.state == \'true\') { mui.alert("退出登录成功！",function(){ if (mui.os.ios || mui.os.ipad || mui.os.iphone||mui.os.android) { /*获取所有Webview窗口*/ var curr = plus.webview.currentWebview(); var wvs = plus.webview.all(); for (var i = 0, len = wvs.length; i < len; i++) { /*关闭除setting页面外的其他页面*/ if (wvs[i].getURL() == curr.getURL()) continue; plus.webview.close(wvs[i]); } plus.webview.open(\'/index.html\'); curr.close(); } else{ plus.runtime.quit();} }); } else { mui.alert("退出登录失败！"); } },true ); return false; }); }); jQuery(\'.public_footer\').on(\'tap\',\'.public_gongneng\',function(){ jQuery(\'.public_popUp\').css({\'z-index\':\'10\',\'visibility\':\'visible\',\'transition-delay\':\'0s\'}); jQuery(\'.popUp_item\').addClass(\'active\'); jQuery(\'.popUp_row\').css({\'transform\':\'translateY(0)\',\'transition-delay\':\'0s\'}); jQuery(\'.popUp_item:nth-child(1),.popUp_item:nth-child(2),.popUp_item:nth-child(3),.popUp_item:nth-child(4)\').css(\'transition-delay\',\'.05s\'); jQuery(\'.popUp_item:nth-child(5),.popUp_item:nth-child(6),.popUp_item:nth-child(7),.popUp_item:nth-child(8)\').css(\'transition-delay\',\'.1s\'); jQuery(\'.popUp_item:nth-child(9),.popUp_item:nth-child(10),.popUp_item:nth-child(11),.popUp_item:nth-child(12)\').css(\'transition-delay\',\'.13s\'); jQuery(\'.popUp_item:nth-child(13),.popUp_item:nth-child(14),.popUp_item:nth-child(15),.popUp_item:nth-child(16)\').css(\'transition-delay\',\'.17s\'); }); jQuery(\'.popUp_row\').on(\'tap\',\'.popUp_close\',function(){ jQuery(\'.public_popUp\').css({\'z-index\':\'-1\',\'visibility\':\'hidden\',\'transition-delay\':\'.4s\'}); jQuery(\'.popUp_item\').removeClass(\'active\'); jQuery(\'.popUp_row\').css({\'transform\':\'translateY(100%)\',\'transition-delay\':\'.4s\',\'opcity\':\'0\'}); jQuery(\'.popUp_item:nth-child(1),.popUp_item:nth-child(2),.popUp_item:nth-child(3),.popUp_item:nth-child(4)\').css(\'transition-delay\',\'.12s\'); jQuery(\'.popUp_item:nth-child(5),.popUp_item:nth-child(6),.popUp_item:nth-child(7),.popUp_item:nth-child(8)\').css(\'transition-delay\',\'.09s\'); jQuery(\'.popUp_item:nth-child(9),.popUp_item:nth-child(10),.popUp_item:nth-child(11),.popUp_item:nth-child(12)\').css(\'transition-delay\',\'.06s\'); jQuery(\'.popUp_item:nth-child(13),.popUp_item:nth-child(14),.popUp_item:nth-child(15),.popUp_item:nth-child(16)\').css(\'transition-delay\',\'.03s\'); }); jQuery(\'.popUp_content\').on(\'tap\', \'a\', function(){ jQuery(\'.public_popUp\').css({\'z-index\':\'-1\',\'visibility\':\'hidden\',\'transition-delay\':\'.2s\'}); jQuery(\'.popUp_item\').removeClass(\'active\'); jQuery(\'.popUp_row\').css({\'transform\':\'translateY(100%)\',\'transition-delay\':\'.4s\',\'opcity\':\'0\'}); var navid = jQuery(this).attr(\'data-id\'); var jumpTohref = \'\'; switch(navid){ /* 电影 */ case \'4\': ';
if(isTimes == 1){
