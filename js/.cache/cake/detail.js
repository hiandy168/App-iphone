/*TMODJS:{"version":119,"md5":"9a717191d9203781e71882e9bfe6a544"}*/
...
$out+=' </div> </div>  <form action="javascript:addToCart({$goods.goods_id})" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" onsubmit="return false"> <div class="cake_details_title mui-row bg_white"> <div class="mui-col-xs-8"> <h4>';
$out+=$escape(data.goods.goods_name);
$out+='</h4> <span class="color_coral" id=\'price-total\'>--</span> </div> <div class="mui-col-xs-4 mui-text-right"> <div class="mui-numbox" data-numbox-min=\'1\'> <button class="mui-btn-numbox-minus" type="button">-</button> <input class="mui-input-numbox" type="number" name="number" id="number" /> <button class="mui-btn-numbox-plus" type="button">+</button> </div> </div> </div> <div class="container xiangqing bg_white"> <div class="mui-row"> <div class="mui-col-xs-3"> <h5 class="mui-pull-right guige_1">规格：</h5> </div> <div class="mui-col-xs-9"> ';
...
$out+='</div> ';
if(data.goods.extension_code=='virtual_card'){
$out+=' <div style="color: red;background: white;padding: 5px 5px 20px 5px;">商品码短信自您购买之时起24小时后发送到您手机，请注意查收</div> ';
}
$out+=' <div style="padding: 10px 10px;" class="bg_white">   <div id="item1" class="mui-control-content mui-active"> <ul class="mui-table-view"> ';
